...
beta := Matrix(K, [[v[1,1], 2/r], [2/r, v[1,2]]]);
...
*/
/* One of the others also works to get from 108 to 36: */
...
repeat
    ...
    if Determinant(w) ne 0 then
        gensM := [ w*toM(toQ(A ! Eltseq(MatrixInBasis(gen, B))))*w^(-1) : gen in gensGamma ];
