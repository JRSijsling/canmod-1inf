...
print "Check that we have group number 11:";
print IsConjugate(G, H, Lat[11]);

print "Permutation representations for intermediate covers:";

/*
f11 := CosetAction(G, Lat[11]);
print "---";
print f11(sigma2); print f11(sigma3); print f11(sigmainf);
*/

f20 := CosetAction(G, Lat[20]);
print "---";
print f20(sigma2); print f20(sigma3); print f20(sigmainf);

f22 := CosetAction(G, Lat[22]);
print "---";
print f22(sigma2); print f22(sigma3); print f22(sigmainf);
